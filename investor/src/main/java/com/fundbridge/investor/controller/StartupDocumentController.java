...
import com.fundbridge.investor.service.StartupDocumentService;
...
public class StartupDocumentController {
    ...
    @PostMapping
    ResponseEntity<StartupDocumentResponseDto>addDocument(@Valid @RequestBody StartupDocumentRequestDto request,
                                                          @ModelAttribute ("USER-ID") UUID userId,
